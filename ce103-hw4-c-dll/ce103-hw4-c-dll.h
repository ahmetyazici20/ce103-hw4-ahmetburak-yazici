 ...
 **************************/
 ...
 /**
  * @file CE103-HW4.h
  * @author Ahmet Burak Yazıcı
  * @date 31 December 2021
  *
  * @brief <b> HW-4 Functions </b>
  *
  * HW-4 Sample Lib Functions Header
  *
...
extern "C" {                   //pointing c 
	...
	/**
	 @name TestFunction(fnCE103HW4Lib)
	 ...
	 @image html fnCE103HW4Lib.png
	 @image rtf fnCE103H4Lib.png
	 @image latex fnCE103HW2Lib.png
	 <!--
		@startuml fnCE103HW4Lib.png
	...
	**/
	__declspec(dllexport) int hw4_fibonacciNumber(int fiIndex);
	...
	**/
	__declspec(dllexport) char* hw4_strrev(char* fiStr);
	...
	**/
	__declspec(dllexport) int hw4_strlen(const char* fiStr);
	...
	**/
	__declspec(dllexport) char* hw4_strcat(char* fiDest, char* fiSrc);
	...
	**/
	__declspec(dllexport) int hw4_strcmp(const char* fiLhs, const char* fiRhs);
	...
	**/
	__declspec(dllexport)	char* hw4_strcpy(char* foDestination, const char* fiSource);
	 ...
	 */
	__declspec(dllexport) void hw4_hex2bin(char* fiHex, int fiHexLen, unsigned char* foBin);
	...
	*
	*/
	__declspec(dllexport) void hw4_bin2hex(unsigned char* fiBin, int fiBinLen, char* foHex);
